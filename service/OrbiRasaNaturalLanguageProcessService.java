...
public class OrbiRasaNaturalLanguageProcessService extends BaseService {
    ...
    public OrbiRasaNaturalLanguageProcessService() throws IOException {
        propertiesUtil = new PropertiesUtil();
        RequestManager.shared().setBaseURI(propertiesUtil
                .getPropertyByName("orbi.rasa.naturallanguageprocess.baseURI"));
